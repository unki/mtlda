...
-->
  ...
  <!-- <script type="text/javascript" src="{$web_path}/resources/jquery/plugins/jquery.color.js"></script> -->
  <!-- jQuery UI -->
  ...
  <script type="text/javascript" src="{$web_path}/resources/mtlda_message.js"></script>
  <!-- MTLDA CSS -->
