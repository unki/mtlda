...
class MTLDA_Requirements_Controller {
    ...
    public function check()
    {
        ...
        switch($config['database']['type']) {
            case 'mysql':   $db_class_name = "mysqli"; $db_pdo_name = "mysql"; break;
            case 'sqlite3': $db_class_name = "Sqlite3"; $db_pdo_name = "sqlite"; break;
            default:        $db_class_name = NULL; $db_pdo_name = NULL; break;
        }
