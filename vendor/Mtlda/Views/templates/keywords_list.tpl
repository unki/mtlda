...
{keywords_list}
 <tr>
  ...
  <td>
   <div name="keyword_{$item->getIdx()}" class="filterable inline editable content" data-current-value="{$item->getName()}" data-orig-value="{$item->getName()}" style="float: left;">{$item->getName()}</div>&nbsp;
   <a name="keyword_{$item->getIdx()}" class="inline editable edit link" data-inline-name="keyword_{$item->getIdx()}"><i class="tiny edit icon"></i></a>
   <div name="keyword_{$item->getIdx()}" class="inline editable formsrc" style="display: none;">
  ...
  <td>
   <div class="ui icon buttons">
    <a id="delete_link_{$item->getIdx()}" class="delete item ui icon button action link" data-action-title="Deleting {$item->getName()|escape}" data-modal-title="Delete {$item->getName()|escape}" data-modal-text="Please confirm to delete {$item->getName()|escape}" data-id="{$item->getIdx()}" data-guid="{$item->getGuid()}" data-model="keyword" data-content="Delete {$item->getName()|escape}" data-variation="wide"><i class="remove circle icon"></i></a>
   </div>
  </td>
 </tr>
{/keywords_list}
