...
{archive_list}
 <tr>
  <td><a href="{get_url page=archive mode=edit id=$item_safe_link}">{$item->archive_idx}</a></td>
  <td><a href="{get_url page=archive mode=edit id=$item_safe_link}">{$item->archive_file_name}</a></td>
